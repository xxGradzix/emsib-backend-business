...
class AuthControllerIntegrationTest {
    ...
    void register_then_login_and_token_isValid() throws Exception {
        // register
        var register = new com.emsib.emsib_backend_business.security.securitymodule.auth.dto.RegisterRequest();
        ...
        // login
        var login = new com.emsib.emsib_backend_business.security.securitymodule.auth.dto.LoginRequest();
